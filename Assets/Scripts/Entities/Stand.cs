...
public class Stand : Entity
{
    ...
    private IEnumerator InitiateRings(int ringsCount)
    {
        for (var i = 0; i < ringsCount; i++)
        {
            ...
            HandleRingMaterial(ringTransform, ring);
    ...
    private void HandleRingMaterial(Transform ringTransform, Entity ring)
    {
        ...
        Manager.instance.selectionManager.materials.TryAdd(ringTransform, ringMaterial);
